  ...
  then
    ...
    then
      ...
      then
        ...
        echo $DATA | while read BAR BAR NUMBER BAR SYMBOL BAR NAME BAR WEIGHT BAR MELTING BAR BOILING BAR TYPE BAR
        do
          
          echo "The element with atomic number $NUMBER is $NAME ($SYMBOL). It's a $WEIGHT, with a mass of $MELTING amu. $NAME has a melting point of $BOILING celsius and a boiling point of $TYPE celsius."
